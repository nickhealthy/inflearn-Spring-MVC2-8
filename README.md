...
스프링은 `MultipartFile`이라는 인터페이스로 멀티파트를 매우 편리하게 지원한다.
...
* `@RequestParam MultipartFile file`
  * 업로드하는 HTML Form name에 맞추어 `@RequestParam`을 적용하면 된다.
  * 추가로 @ModelAttribute에서도 `MultipartFile`을 동일하게 사용할 수 있다.
...
itemName=상품A multipartFile=org.springframework.web.multipart.support.StandardMultipartHttpSer vletRequest$StandardMultipartFile@274ba730
파일 저장 fullPath=/Users/kimyounghan/study/file/스크린샷.png 
```
